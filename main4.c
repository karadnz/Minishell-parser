...
typedef enum { NONE, PIPE, REDIRECT_IN, REDIRECT_OUT, HEREDOC } CommandType;
...
int main() {
    ...
    printf("Welcome to the simple shell with multiple piping, redirection, and heredocs support!\n");
